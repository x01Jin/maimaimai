...
import { INITIAL_STATE, sessionUtils, createSystemMessage, finalizeState } from '../../utils/sessionUtils';
...
interface MessagingProps {
  ...
  updateState: (updater: (prev: GameState) => GameState, lastAction?: ClientAction) => void;
...
export const usePeerMessaging = ({
  ...
  }, [myId, updateState, sendTo, broadcast, modPeerIdRef, lastModPulseRef, gameStateRef, setGameState, connectToPeer, tryCaptureBeacon, sessionCode, qualityMetricsRef]);
